...
<?php include('inc/modules/chat.php'); ?>	
</div>
<div class="row">
...
<div class="m-portlet  m-portlet--full-height ">
	...
	<div class="m-portlet__body">
		<div class="m-scrollable m-scroller ps ps--active-y" data-scrollable="true" data-height="380" data-mobile-height="300" style="height: 380px; overflow: hidden;">
			...
			<!--End::Timeline 2 -->
		<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 380px; right: 4px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 277px;"></div></div></div>
	</div>
</div>
<!--End::Portlet-->	</div>
	<div class="col-xl-6 col-lg-12">
...
<div class="m-portlet m-portlet--full-height ">
	<div class="m-portlet__head">
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<h3 class="m-portlet__head-text">
					Recent News (jointures de tables)
				</h3>
			</div>
		</div>
		<div class="m-portlet__head-tools">
			<ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm" role="tablist">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#m_modal_1">+</button>
				</li>
			</ul>
        </div>
        <?php include('inc/modules/modals/modal-add-news.php'); ?>
	</div>
	<div class="m-portlet__body">
			...
			<div class="tab-pane active" id="m_widget2_tab1_content">
				...
				<div class="m-timeline-3">
					<div class="m-timeline-3__items">
                       ...
                       /*  $client = $_SESSION['activity']['email'];
